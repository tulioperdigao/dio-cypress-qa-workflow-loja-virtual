...
- **Histórias de usuário** (com valor, narrativa e regras de negócio)
- **Critérios de aceite** (incluindo versão em Gherkin quando aplicável)
- **Fluxos / mapeamento de jornada** (ex.: login → cadastro → carrinho → checkout)
- **Documentação de teste** (estratégia, escopo, tipos de teste, evidências)
- Base para evolução em **testes E2E com Cypress** 
